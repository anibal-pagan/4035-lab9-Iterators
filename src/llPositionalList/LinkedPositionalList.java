...
public class LinkedPositionalList<E> implements PositionalList<E> {
	...
	private DNode<E> validate(Position<E> p) throws IllegalArgumentException { 
		try { 
			...
			if(dp.getList()!=this)
				throw new IllegalArgumentException("Not a node in this list."); 
	...
	public Iterable<Position<E>> backwardPositions() { 
		return new PositionBackwardIterable(); 
	}
	...
	public Iterator<E> backwardIterator() {
		return new ElementBackwardIterator();
	}
	...
	private class ElementIterator implements Iterator<E> { 
		Iterator<Position<E>> posIterator = 
				LinkedPositionalList.this.iteratorMaker.makeIterator(LinkedPositionalList.this); 
		@Override
		public boolean hasNext() {
	...
	private class PositionBackwardIterable implements Iterable<Position<E>> {

		@Override
		public Iterator<Position<E>> iterator() {
			return new PositionBackwardIterator();
		} 
